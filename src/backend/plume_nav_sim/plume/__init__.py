...
from ..core.types import (  # noqa: E402; Core data structures for coordinate and grid management; Grid dimension representation for type annotations and factory functions
    GridSize,
)
...
from .concentration_field import (  # noqa: E402; Core concentration field class for efficient 2D field management; Factory and utility functions for concentration field operations; Specialized exceptions for concentration field operations; Comprehensive parameter validation for concentration field initialization
...
from .static_gaussian import (  # noqa: E402; Main static Gaussian plume model class with mathematical implementation; Factory and utility functions for Gaussian plume operations; Specialized exception for StaticGaussianPlume-specific errors; Comprehensive parameter validation for static Gaussian plume model
    ...
    with _module_lock:
        ...
        try:
            ...
            if validate_dependencies:
                ...
                try:
                    import typing  # noqa: E402  # >=3.10 - Type system support for interfaces and protocols

                    import numpy  # noqa: E402  # >=2.1.0 - Mathematical operations and array handling
