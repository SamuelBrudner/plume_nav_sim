    ...
    try:
        ...
        if assets_dir.exists():
            package_data_patterns.extend(
                ["assets/*.py", "assets/*.json", "assets/*.txt"]
            )
        ...
        if data_dir.exists():
            package_data_patterns.extend(
                ["data/*.py", "data/*.json", "data/*.csv", "data/*.txt"]
            )
        ...
        if logging_dir.exists():
            package_data_patterns.extend(
                ["logging/*.py", "logging/*.json", "logging/*.yaml", "logging/*.yml"]
            )

        # Return comprehensive package_data dictionary for setuptools inclusion
        return {"plume_nav_sim": package_data_patterns} if package_data_patterns else {}
