...
def test_performance_analysis_contract():
    ...
    trends = analysis.analyze_performance_trends({
        'step_latency': {'mean_step_time_ms': 1.0, 'p95_step_time_ms': 2.0, 'std_dev_step_time_ms': 0.2},
    ...
    recs = analysis.generate_optimization_recommendations(DummyResult(), trends, include_scaling_guidance=True)
