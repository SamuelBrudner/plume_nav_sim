...
class NavigatorFactory:
    ...
    def from_config(config: Union[DictConfig, NavigatorConfig, dict]) -> NavigatorProtocol:
        ...
        Examples:
            ...
            From Pydantic model:
            >>> from odor_plume_nav.domain.models import NavigatorConfig
            >>> config = NavigatorConfig(position=(10.0, 20.0), max_speed=2.0)
            >>> navigator = NavigatorFactory.from_config(config)
        """
        # Import here to avoid circular imports
        from odor_plume_nav.services.control_loops import SingleAgentController, MultiAgentController
    ...
    def single_agent(
        ...
        Examples:
            ...
            ... )
        """
        from odor_plume_nav.services.control_loops import SingleAgentController
    ...
    def multi_agent(
        ...
        Examples:
            ...
            ... )
        """
        from odor_plume_nav.services.control_loops import MultiAgentController
