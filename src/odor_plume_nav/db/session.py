...
Examples:
    Basic usage (inactive by default):
        ```python
        from odor_plume_nav.db.session import DatabaseConfig, get_session
    ...
    Explicit database activation:
        ```python
        import os
        from odor_plume_nav.db.session import DatabaseSessionManager
...
def get_session_manager() -> DatabaseSessionManager:
    ...
    Examples:
        Simple usage:
            ```python
            from odor_plume_nav.db.session import get_session_manager
...
def configure_database(config: DatabaseConfig) -> None:
    ...
    Examples:
        Application setup:
            ```python
            from odor_plume_nav.db.session import configure_database, DatabaseConfig
            ...
            from odor_plume_nav.db.session import get_default_session
