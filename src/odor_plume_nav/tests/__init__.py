"""
Library-internal test package for odor_plume_nav.
...
Pytest Discovery:
    ...
    following the unified odor_plume_nav package architecture requirements.
...
Example Usage:
    Run all library tests:
        pytest src/odor_plume_nav/tests/

    Run specific test categories:
        pytest src/odor_plume_nav/tests/core/
        pytest src/odor_plume_nav/tests/config/
        pytest src/odor_plume_nav/tests/cli/

    Run with coverage analysis:
        pytest --cov=odor_plume_nav src/odor_plume_nav/tests/
...
def get_test_data_path():
    ...
    Example:
        >>> from src.odor_plume_nav.tests import get_test_data_path
