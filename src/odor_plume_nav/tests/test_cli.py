...
from odor_plume_nav.cli.main import (
...
class TestCLIRunCommand:
    ...
    def setup_mocks(self, mock_config, mock_navigator, mock_video_plume):
        ...
        with patch('odor_plume_nav.cli.main.get_cli_config', return_value=mock_config):
            with patch('odor_plume_nav.cli.main.create_navigator', return_value=mock_navigator):
                with patch('odor_plume_nav.cli.main.create_video_plume', return_value=mock_video_plume):
                    with patch('odor_plume_nav.cli.main.run_plume_simulation') as mock_sim:
                        ...
                        with patch('odor_plume_nav.cli.main.initialize_system') as mock_init:
                            mock_init.return_value = {'config': mock_config, 'initialized_at': time.time()}
                            
                            with patch('odor_plume_nav.cli.main.cleanup_system'):
                                with patch('odor_plume_nav.cli.main.validate_configuration'):
...
class TestCLIConfigCommands:
    ...
    def setup_config_mocks(self, mock_config):
        ...
        with patch('odor_plume_nav.cli.main.get_cli_config', return_value=mock_config):
            with patch('odor_plume_nav.cli.main.validate_configuration', return_value=True):
                yield
...
class TestCLIVisualizeCommand:
    ...
    def setup_visualization_mocks(self):
        ...
        with patch('odor_plume_nav.cli.main.visualize_simulation_results') as mock_viz:
            mock_figure = Mock()
            mock_figure.savefig = Mock()
            mock_viz.return_value = mock_figure
            
            with patch('odor_plume_nav.cli.main.export_animation') as mock_export:
...
class TestCLIErrorHandling:
    ...
    @patch('odor_plume_nav.cli.main.get_cli_config', return_value=None)
...
class TestCLIHydraIntegration:
    ...
    @patch('odor_plume_nav.cli.main.get_cli_config')
...
class TestCLIConfigurationValidation:
    ...
    def test_validate_configuration_success(self, valid_config):
        ...
        with patch('pathlib.Path.exists', return_value=True):
            with patch('odor_plume_nav.config.schemas.NavigatorConfig') as mock_nav_config:
                with patch('odor_plume_nav.config.schemas.VideoPlumeConfig') as mock_video_config:
                    with patch('odor_plume_nav.config.schemas.SimulationConfig') as mock_sim_config:
    ...
    def test_validate_configuration_with_errors(self):
        ...
        with patch('odor_plume_nav.config.schemas.NavigatorConfig') as mock_config:
...
class TestCLISystemManagement:
    ...
    def test_initialize_system_success(self, mock_config):
        ...
        with patch('odor_plume_nav.cli.main.setup_logging'):
            with patch('odor_plume_nav.cli.main.set_global_seed') as mock_seed:
                mock_seed.return_value = 42
                with patch('odor_plume_nav.cli.main.get_current_seed', return_value=42):
    ...
    def test_initialize_system_with_database(self, mock_config):
        ...
        with patch('odor_plume_nav.cli.main.setup_logging'):
            with patch('odor_plume_nav.cli.main.set_global_seed'):
                with patch('odor_plume_nav.cli.main.get_session') as mock_get_session:
                    mock_session = Mock()
    ...
    def test_cleanup_system(self):
        ...
        with patch('odor_plume_nav.cli.main.close_session') as mock_close:
    ...
    def test_cleanup_system_with_errors(self):
        ...
        with patch('odor_plume_nav.cli.main.close_session', side_effect=Exception("Close error")):
