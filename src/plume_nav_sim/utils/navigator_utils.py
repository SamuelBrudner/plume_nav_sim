"""
Comprehensive navigator utilities providing unified creation patterns, sensor management, state operations, and performance monitoring for all navigator implementations.
...
- Multiple configuration patterns including Hydra, Pydantic, and direct parameters
- Comprehensive sensor layout management and transformation utilities
- Enhanced state management helpers with vectorized operations
- Performance monitoring and introspection capabilities
- CLI and database integration utilities

The enhanced functions maintain backward compatibility while adding advanced
configuration features and Gymnasium 0.29 compliance for the plume navigation
ecosystem migration.

Key Features:
- Factory functions for multiple instantiation patterns (Hydra, Pydantic, direct)
- Predefined sensor layouts with transformation utilities
- State management helpers with vectorized operations
- Performance monitoring context managers
- Introspection utilities for navigator capabilities
- CLI and database integration for operational environments
...
PREDEFINED_SENSOR_LAYOUTS: Dict[str, np.ndarray] = {
    ...
    # Four cardinal directions around the agent
    "CARDINAL": np.array([
        [1.0,  0.0],   # Front
        [0.0,  1.0],   # Left
        [-1.0, 0.0],   # Back
...
# Enhanced exports for comprehensive navigator management functionality
__all__ = [
