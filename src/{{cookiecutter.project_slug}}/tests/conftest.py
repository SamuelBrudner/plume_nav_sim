...
- Supports cookiecutter template structure conventions
...
try:
    from {{cookiecutter.project_slug}}.cli.main import cli as main_cli
    from {{cookiecutter.project_slug}}.db.session import SessionManager, get_session
    CLI_AVAILABLE = True
except ImportError:
    CLI_AVAILABLE = False
