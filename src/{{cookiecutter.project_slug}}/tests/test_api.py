...
from {{cookiecutter.project_slug}}.core.navigator import NavigatorProtocol, Navigator
...
class TestRunPlumeSimulation:
    ...
    def test_run_plume_simulation_seed_management(self):
        ...
        with patch('{{cookiecutter.project_slug}}.api.navigation.set_global_seed') as mock_set_seed:
